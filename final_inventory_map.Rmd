...
(year and haul # should give station information and from station we can find lat long values)
...
### Create an interactive map via leaflet-- 
the below code will plot a map with blue lanternfish for demo purposes, but shiny app will have a selection box for spp

leaflet.tile <- "Esri.OceanBasemap" 

# A very basic Leaflet map-- ex. blue lanternfish
m <- leaflet() %>% 
...
# okay, then I used these exploratory code to create a shiny app (stored in freezer_inventory)
shiny app is found at freezer_inventory//shiny_freezer// 
i also created a separate R project for the shiny app in order to publish without issue